...
namespace Netlist {
  ...
  void  CellWidget::resizeEvent ( QResizeEvent* event )
  {
    ...
    viewport->setX2(viewport->getX1() + size.width());
    viewport->setY1(viewport->getY2() - size.height());
    //std::cerr << "CellWidget::resizeEvent() viewport : " << (*viewport) << std::endl;
  }
